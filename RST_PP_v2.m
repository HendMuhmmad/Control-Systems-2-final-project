...
[numur,denur]= tfdata(U_r,'v')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%OUTPUT tf parameters
% to generate file.h
fileID = fopen('output_tf.h','w');
fprintf(fileID,'#ifndef output_tf_H_\n');
fprintf(fileID,'#define output_zH_\n');
fprintf(fileID,'extern const float num_cr[');
fprintf(fileID,num2str(length(numcr)));
fprintf(fileID,'],den_cr[');
fprintf(fileID,num2str(length(dencr)));
fprintf(fileID,'],num_ur[');
fprintf(fileID,num2str(length(numur)));
fprintf(fileID,'],den_ur[');
fprintf(fileID,num2str(length(denur)));
fprintf(fileID,'];\n');
fprintf(fileID,'extern  float c[');
fprintf(fileID,num2str(length(numcr)));
fprintf(fileID,'],u[');
fprintf(fileID,num2str(length(numur)));
fprintf(fileID,'],r[');
if(length(numcr) >= length(numur))
   fprintf(fileID,num2str(length(numcr)));
else
   fprintf(fileID,num2str(length(numur)));
end
fprintf(fileID,'];\n');
fprintf(fileID,'extern const int size_nur,size_ncr,size_r;\n');
fprintf(fileID,'#endif\n');
fclose(fileID);


% to generate file.cpp
fileID = fopen('output_tf.c','w');
fprintf(fileID,'#include "output_tf.h"\n');
fprintf(fileID,'const float num_cr[]={');
for i=1:length(numcr)
if(i==length(numcr))
fprintf(fileID,num2str(numcr(i)));
else
fprintf(fileID,[num2str(numcr(i)) ',']);
end
...
fprintf(fileID,'const float den_cr[]={');
for i=1:length(dencr)
if(i==length(dencr))
fprintf(fileID,num2str(dencr(i)));
else
fprintf(fileID,[num2str(dencr(i)) ',']);
end
...
fprintf(fileID,'};\n');
fprintf(fileID,'const float num_ur[]={');
for i=1:length(numur)
if(i==length(numur))
fprintf(fileID,num2str(numur(i)));
else
fprintf(fileID,[num2str(numur(i)) ',']);
end
end
...
fprintf(fileID,'const float den_ur[]={');
for i=1:length(denur)
if(i==length(denur))
fprintf(fileID,num2str(denur(i)));
else
fprintf(fileID,[num2str(denur(i)) ',']);
end
end
fprintf(fileID,'};\n');
fprintf(fileID,'float c[],u[],r[];\n');
% int size_nur,size_dur,size_ncr,size_dcr
fprintf(fileID,'const int size_nur =');
fprintf(fileID,num2str(length(numur)));
fprintf(fileID,';\n');

fprintf(fileID,'const int size_ncr =');
fprintf(fileID,num2str(length(numcr)));
fprintf(fileID,';\n');
fprintf(fileID,'const int size_r =');
if(length(numcr) >= length(numur))
   fprintf(fileID,num2str(length(numcr)));
else
   fprintf(fileID,num2str(length(numur)));
...
fprintf(fileID,num2str(length(Bp)));
fprintf(fileID,'],Ap[');
fprintf(fileID,num2str(length(Ap)));
fprintf(fileID,'],P[');
fprintf(fileID,num2str(length(P)));
fprintf(fileID,'];\n');
fprintf(fileID,'#endif\n');
fclose(fileID);
...
fprintf(fileID,'const float Bp[]={');
for i=1:length(Bp)
if(i==length(Bp))
fprintf(fileID,num2str(Bp(i)));
else
fprintf(fileID,[num2str(Bp(i)) ',']);
end
...
fprintf(fileID,'const float Ap[]={');
for i=1:length(Ap)
if(i==length(Ap))
fprintf(fileID,num2str(Ap(i)));
else
fprintf(fileID,[num2str(Ap(i)) ',']);
end
...
fprintf(fileID,'const float P[]={');
for i=1:length(P)
if(i==length(P))
fprintf(fileID,num2str(P(i)));
else
fprintf(fileID,[num2str(P(i)) ',']);
end
...
fprintf(fileID,'],S[');
fprintf(fileID,num2str(length(S)));
fprintf(fileID,'],T[');
fprintf(fileID,num2str(length(T)));
fprintf(fileID,'];\n');
fprintf(fileID,'#endif\n');
fclose(fileID);
...
fprintf(fileID,'const float R[]={');
for i=1:length(R)
if(i==length(R))
fprintf(fileID,num2str(R(i)));
else
fprintf(fileID,[num2str(R(i)) ',']);
end
...
fprintf(fileID,'const float S[]={');
for i=1:length(S)
if(i==length(S))
fprintf(fileID,num2str(S(i)));
else
fprintf(fileID,[num2str(S(i)) ',']);
end
...
fprintf(fileID,'};\n');
fprintf(fileID,'const float T[]={');
for i=1:length(T)
if(i==length(T))
fprintf(fileID,num2str(T(i)));
else
fprintf(fileID,[num2str(T(i)) ',']);
end
end
